 ...
 *
 */
public class ClickAnimTextView extends TextView {
	...
	public ClickAnimTextView(Context context) {
		super(context);
		this.setClickable(true);
	}

	public ClickAnimTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.setClickable(true);
	}

	public ClickAnimTextView(Context context, AttributeSet attrs, int defStyle) {
