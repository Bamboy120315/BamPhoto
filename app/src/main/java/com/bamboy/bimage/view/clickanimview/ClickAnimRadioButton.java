 ...
 *
 */
public class ClickAnimRadioButton extends RadioButton {
	...
	public ClickAnimRadioButton(Context context) {
		super(context);
		this.setClickable(true);
	}

	public ClickAnimRadioButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.setClickable(true);
	}

	public ClickAnimRadioButton(Context context, AttributeSet attrs, int defStyle) {
