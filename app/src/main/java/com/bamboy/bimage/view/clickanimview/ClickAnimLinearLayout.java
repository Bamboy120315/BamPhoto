 ...
 *
 */
public class ClickAnimLinearLayout extends LinearLayout {
	...
	public ClickAnimLinearLayout(Context context) {
		super(context);
		this.setClickable(true);
	}

	public ClickAnimLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.setClickable(true);
	}

	public ClickAnimLinearLayout(Context context, AttributeSet attrs, int defStyle) {
