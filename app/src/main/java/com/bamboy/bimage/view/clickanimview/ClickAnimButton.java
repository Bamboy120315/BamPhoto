 ...
 *
 */
public class ClickAnimButton extends Button {
	...
	public ClickAnimButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.setClickable(true);
	}

	public ClickAnimButton(Context context, AttributeSet attrs, int defStyle) {
