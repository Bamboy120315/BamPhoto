package com.bamboy.bimage.view.clickanimview;
...
public class BamAnim {
     ...
     * 阴影最小值
     */
    private static final float SHADOW_END = 5;
    ...
    public static void froBig_ToSmall(View view) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 21) {
                ...
                if (tzStart == 0) {
                    tzStart = view.getElevation();
                }
                if (viewTag == null || false == viewTag instanceof Float) {
                    view.setTag(R.string.tag_key_translation_z, tzStart / 2);
                }
            }
             ...
             * Z轴变低
             */
            PropertyValuesHolder elevation = PropertyValuesHolder.ofFloat("elevation", tzStart, SHADOW_END);
            /**
             * 控件的宽变小
             */
             ...
             * 动画集合，所有动画一起播放
             */
            ObjectAnimator animatorD = ObjectAnimator.ofPropertyValuesHolder(view, tz, elevation, sx, sy).setDuration(ANIM_SPEED);
    ...
    public static void froSmall_ToBig(View view) {
        try {
             ...
             * Z轴变低
             */
            PropertyValuesHolder elevation = PropertyValuesHolder.ofFloat("elevation", tzStart, tzEnd);
            /**
             * 控件的宽变小
             */
