package com.bamboy.bimage.view.ijkplayer;
...
public class IjkPlayer extends ViewGroup {
     ...
     * 构造
     */
    public IjkPlayer(Context context, RelativeLayout rl_root) {
        super(context);
     ...
     * 构造
     */
    public IjkPlayer(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
