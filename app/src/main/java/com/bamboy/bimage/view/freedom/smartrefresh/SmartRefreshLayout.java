package com.bamboy.bimage.view.freedom.smartrefresh;
...
import com.bamboy.bimage.view.freedom.smartrefresh.api.DefaultRefreshFooterCreator;
import com.bamboy.bimage.view.freedom.smartrefresh.api.DefaultRefreshHeaderCreator;
import com.bamboy.bimage.view.freedom.smartrefresh.api.DefaultRefreshInitializer;
import com.bamboy.bimage.view.freedom.smartrefresh.api.RefreshContent;
import com.bamboy.bimage.view.freedom.smartrefresh.api.RefreshFooter;
import com.bamboy.bimage.view.freedom.smartrefresh.api.RefreshHeader;
import com.bamboy.bimage.view.freedom.smartrefresh.api.RefreshInternal;
import com.bamboy.bimage.view.freedom.smartrefresh.api.RefreshKernel;
import com.bamboy.bimage.view.freedom.smartrefresh.api.RefreshLayout;
import com.bamboy.bimage.view.freedom.smartrefresh.api.ScrollBoundaryDecider;
import com.bamboy.bimage.view.freedom.smartrefresh.constant.DimensionStatus;
import com.bamboy.bimage.view.freedom.smartrefresh.constant.RefreshState;
import com.bamboy.bimage.view.freedom.smartrefresh.constant.SpinnerStyle;
import com.bamboy.bimage.view.freedom.smartrefresh.footer.BallPulseFooter;
import com.bamboy.bimage.view.freedom.smartrefresh.header.SlopeHeader;
import com.bamboy.bimage.view.freedom.smartrefresh.impl.RefreshContentWrapper;
import com.bamboy.bimage.view.freedom.smartrefresh.impl.RefreshFooterWrapper;
import com.bamboy.bimage.view.freedom.smartrefresh.impl.RefreshHeaderWrapper;
import com.bamboy.bimage.view.freedom.smartrefresh.listener.OnLoadMoreListener;
import com.bamboy.bimage.view.freedom.smartrefresh.listener.OnMultiPurposeListener;
import com.bamboy.bimage.view.freedom.smartrefresh.listener.OnRefreshListener;
import com.bamboy.bimage.view.freedom.smartrefresh.listener.OnRefreshLoadMoreListener;
import com.bamboy.bimage.view.freedom.smartrefresh.listener.OnStateChangedListener;
import com.bamboy.bimage.view.freedom.smartrefresh.util.DelayedRunnable;
import com.bamboy.bimage.view.freedom.smartrefresh.util.DensityUtil;
import com.bamboy.bimage.view.freedom.smartrefresh.util.ViscousFluidInterpolator;
...
import static com.bamboy.bimage.view.freedom.smartrefresh.util.DensityUtil.dp2px;
import static com.bamboy.bimage.view.freedom.smartrefresh.util.SmartUtil.fling;
import static com.bamboy.bimage.view.freedom.smartrefresh.util.SmartUtil.getColor;
import static com.bamboy.bimage.view.freedom.smartrefresh.util.SmartUtil.isContentView;
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshHeader == null) {
                if (sHeaderCreator != null) {
                    ...
                    setRefreshHeader(new SlopeHeader(thisView.getContext()));
                }
            }
...
//    }
    ...
    /**
     * 获取下拉最大高度和Header高度的比率
     *
     * @return ratio = (the maximum height to drag footer)/(the height of footer)
     * 比率 = 下拉最大高度 / Footer的高度
     */
    ...
    /**
     * 获取 触发刷新距离 与 HeaderHeight 的比率
     *
     * @return 触发刷新距离 与 HeaderHeight 的比率
     */
     ...
     * Recommended {@link com.bamboy.freedom.ui.smartrefresh.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.bamboy.freedom.ui.smartrefresh.listener.SimpleMultiPurposeListener}
     *
     ...
     * Recommended {@link com.bamboy.freedom.ui.smartrefresh.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.bamboy.freedom.ui.smartrefresh.impl.ScrollBoundaryDeciderAdapter}
     *
...
//    }
    ...
    public class RefreshKernelImpl implements RefreshKernel {
         ...
         * moveSpinner The name comes from {@link androidx.core.widget.SwipeRefreshLayout#moveSpinner(float)}
         *
